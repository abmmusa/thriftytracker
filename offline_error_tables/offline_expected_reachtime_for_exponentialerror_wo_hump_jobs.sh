...
for file in `ls expected_reachtime_for_exponentialerror_offline/*.pkl`; do
  file_no_prefix=${file##*/}
  echo "python produce_offline_exponentialerror_expected_reachtime_table_wo_hump.py -i expected_reachtime_for_exponentialerror_offline/$file_no_prefix -o ../data/expected_reachtime_for_exponentialerror_wo_hump_${file_no_prefix%.pkl}.txt -p expected_reachtime_for_exponentialerror_offline_wo_hump/$file_no_prefix"
done
