        ...
        for curr_trip_samples in all_trips_samples:
            for i in range(0, len(curr_trip_samples)):
                ...
                if (len(prev_samples) > 0):
                    ...
                    prev_samples_mean_speed = -1.0
                    curr_sample_mean_speed_delta = -1.0
                    prev_samples_mean_acceleration = -1.0
                    curr_sample_mean_acceleration_delta = -1.0
                
                sys.stdout.write(str(prev_samples_mean_speed) + " " + str(curr_sample.speed) + " " + str(curr_sample_mean_speed_delta) + " " + 
                                 str(prev_samples_mean_acceleration) + " " + str(curr_sample.acceleration) + " " + str(curr_sample_mean_acceleration_delta) + " ")
                ...
                if (len(prev_samples) > 0):
                    ...
                    curr_sample_distance_to_mean_center = -1.0
