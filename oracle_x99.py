...
class OracleX99:
    ...
    def _output_best_result_values(self, result_files, output_file, greaterthan_mode):
        ...
        for curr_record[e_keys[0]] in result_files[e_keys[0]]:
            ...
            curr_record_id, curr_record_lat, curr_record_lon, curr_record_result_value, _ = curr_record[e_keys[0]].strip("\n").split(" ")
            ...
            output_file.write(str(curr_record_id) + " " + str(curr_record_lat) + " " + str(curr_record_lon) + " " + str(curr_record_best_result_value) + " 1 x" + str(curr_record_best_result_e_key) + "\n")
...
if __name__ == "__main__":
    ...
    if (extrapolator_indices is not None):
        ...
        all_extrapolator_indices = list(set(filter(lambda x: x != "12" and x != "99", map(lambda x: int(x.split("_")[3][1:]), all_filenames))))
