...
def write_time_error_table(time_error_table, output_file):
...
usage="Usage: python produce_offline_time_expected_error_table -i <input_file> -o <output_file> -e <expected_error_file> -p <pickle_file_for_expected_error> [-h]"
...
if output_file != "":
    ...
    write_time_error_table(time_error_table, fo)
    fo.close()
