	...
	for extrapolator in 3; do
		...
		for delay in $delay_bounds; do
			for period in $periods; do
			    # mean error
				cat processed_evals_output_p${period}_${category}_new/processed_eval_s13_x$extrapolator.txt | awk '$10!=0 {print $4, $5, $7, $9/$10}' | sed 's/d//; s/e//; s/b//' | sort -n -k 1 -k 2 | awk '$2==d {print}' d=$delay | awk '$1==0.25 || $1==0.5 || $1==0.75 || $1==1 || $1==1.5 || $1==2 || $1==3 || $1==4 || $1==5 || $1==6 || $1==7 || $1==8 {print}' > data_new/budget_delay_statistical_maxerror_delay${delay}_p${period}_${category}_extr${extrapolator}
			    
                # max error
				cat processed_evals_output_p${period}_${category}_new/processed_eval_s13_x$extrapolator.txt | awk '$10!=0 {print $4, $5, $11, $9/$10}' | sed 's/d//; s/e//; s/b//' | sort -n -k 1 -k 2 | awk '$2==d {print}' d=$delay | awk '$1==0.25 || $1==0.5 || $1==0.75 || $1==1 || $1==1.5 || $1==2 || $1==3 || $1==4 || $1==5 || $1==6 || $1==7 || $1==8 {print}' > data_new/budget_delay_statistical_maxerror_maxerror_delay${delay}_p${period}_${category}_extr${extrapolator}
		...
		# mean error
		cat processed_evals_output_${category}_new/processed_eval_s4_x$extrapolator.txt | awk '$10!=0 {print $4, $7, $9/$10}' | sed 's/d//; s/e//; s/b//' | sort -n | awk '$1==0.25 || $1==0.5 || $1==0.75 || $1==1 || $1==1.5 || $1==2 || $1==3 || $1==4 || $1==5 || $1==6 || $1==7 || $1==8 {print}' > data_new/budget_delay_strawman_${category}_extr${extrapolator}
		#max error
		cat processed_evals_output_${category}_new/processed_eval_s4_x$extrapolator.txt | awk '$10!=0 {print $4, $11, $9/$10}' | sed 's/d//; s/e//; s/b//' | sort -n | awk '$1==0.25 || $1==0.5 || $1==0.75 || $1==1 || $1==1.5 || $1==2 || $1==3 || $1==4 || $1==5 || $1==6 || $1==7 || $1==8 {print}' > data_new/budget_delay_strawman_maxerror_${category}_extr${extrapolator}
